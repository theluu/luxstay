...
@section('content')
      ...
      <div class="sisf-banner position-relative">
         <div class="banner-img">
            <figure>
               <img src="{{ asset('images/room_hero_img1.png') }}" alt="Luxestay">
            </figure>
         </div>
         <div class="sisf-page-title sisf-m sisf-title--standard sisf-alignment--center">
            <div class="sisf-m-inner">
               <div class="sisf-m-content sisf-content-grid ">
                  <h1 class="sisf-m-title text-center entry-title">Rooms</h1>
               </div>
            </div>
         </div>
      </div>
                     ...
                     <div class="sisf-e-inner">
                        <div class="sisf-e-media position-relative">
                           <div class="sisf-image-holder">
                              <figure>
                                 <img src="{{ $room->thumbnail ? asset('storage/' . $room->thumbnail) : asset('images/room-image-1.png') }}" class="w-100" alt="{{ $room->name }}">
                              </figure>
                           </div>
